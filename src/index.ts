...
import { createHooksQwenCommand } from "./commands/hooks-qwen.ts";
import { createHooksPiCommand } from "./commands/hooks-pi.ts";
...
program.addCommand(createHooksQwenCommand());
program.addCommand(createHooksPiCommand());
